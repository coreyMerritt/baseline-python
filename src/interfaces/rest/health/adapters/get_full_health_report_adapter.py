...
class GetFullHealthReportAdapter:
  ...
  def model_to_res(model: FullHealthReport) -> GetFullHealthReportRes:
    get_config_parser_health_report_res = GetConfigParserHealthReportAdapter.model_to_res(
      model.config_parser_health_report
    )
    get_cpu_health_report_res = GetCpuHealthReportAdapter.model_to_res(
      model.cpu_health_report
    )
    get_database_health_report_res = GetDatabaseHealthReportAdapter.model_to_res(
      model.database_health_report
    )
    get_disk_health_report_res = GetDiskHealthReportAdapter.model_to_res(
      model.disk_health_report
    )
    get_environment_health_report_res = GetEnvironmentHealthReportAdapter.model_to_res(
      model.environment_health_report
    )
    get_logger_health_report_res = GetLoggerHealthReportAdapter.model_to_res(
      model.logger_health_report
    )
    get_memory_health_report_res = GetMemoryHealthReportAdapter.model_to_res(
      model.memory_health_report
    )
    get_typicode_health_report_res = GetTypicodeHealthReportAdapter.model_to_res(
